...
namespace OpenRA.Mods.WWI.Activities
{
    public class FindGoods : Activity
    {
        ...
        public override Activity Tick(Actor self)
        {
            ...
            if (trader.tradeBuilding == null)
            {
                return ActivityUtils.SequenceActivities(new Wait(traderInfo.SearchForTradeBuildingDelay), this);
            }
            ...
            {
                return ActivityUtils.SequenceActivities(move.MoveTo(trader.tradeBuilding.Location, 4), this);
            }
